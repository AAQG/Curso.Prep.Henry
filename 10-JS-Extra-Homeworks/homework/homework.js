...
var arregloclaves = Object.entries(objeto);
...
function asAmirror(str) {
  ...
  //Escribe tu código aquí
  // ['The', 'Henry', 'Challenge', 'is', 'close!'] split
  var inversion = str.split(" ").map(function(elemento){
...
function capicua(numero) {
  ...
  //Escribe tu código aquí
  //split es solo para palabras, no para numeros
